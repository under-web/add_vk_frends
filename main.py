...
def sender_vk_spam(min_pause=100, max_pause=260, only_accepts_friends=False, only_delete_sub=True, debug=True):
    """
    ...
    delete_subscribers(only_delete_sub)
...
def delete_subscribers(only_delete_sub):
    """
